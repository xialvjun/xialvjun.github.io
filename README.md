...
- 15.10-16.4，在筑梦园(见工作经历)，学习了`python django konckoutjs angular2`。真正学会使用 linux，而不是大学时的装个双系统半年不用。同时，自己也抽空学习了`redux react-router`(也就是继续学习 react，自认为技术洞察力还行，可惜当初没能说服筑梦圆团队使用 react)。
